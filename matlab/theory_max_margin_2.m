...
%gammavals_max = [0.5 1 1.5 2 2.5 3 3.5 4  4.5 5 5.5 6 6.5  7 7.5 8];
gammavals_max = [2 3 4 5 6 7 8];

sgam = size(gammavals_max);
sols_max_m = zeros(sgam(1),6);
diff= zeros(sgam(1),6);
for gammai =1:sgam(2)
    gamma = gammavals_max(gammai);
